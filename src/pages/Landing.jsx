      ...
      <div>
        <div id="home" className="header-hero bg_cover d-lg-flex align-items-center" style={{ backgroundImage: "url('./images/header-hero.jpg')" }}>
          ...
          <div className="header-shape">
            <img src="images/header-shape.png" alt="shape" />
          </div>
        </div>
        ...
        <section className="analysis-area pt-115 pb-120 bg_cover" style={{ backgroundImage: "url('./images/analysis.jpg')",height:"90vh" }}>
          <div className="container">
            <div className="row justify-content-center">
        ...
        <section id="testimonial" class="testimonial-area pt-70">
          <div class="container">
            <div class="header-hero-content text-center">
              <h2 class="wow fadeInUp moto" data-wow-duration="1s" data-wow-delay="0.2s">Eliminate the tears and the stress of your child with SLD experiences <br />when reading or learning with <span>Lessonify<span /></span></h2>
              <br></br>
              <br></br>
